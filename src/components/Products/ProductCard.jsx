        ...
        {products &&
          products.map((product) => (
            <Link
              ...
              key={product.id}
              className="border p-4 rounded-lg hover:shadow-xl"
            >
              <div className="relative">
                ...
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-6 h-6 text-gray-700 absolute top-2 right-2 cursor-pointer"
                >
                  <path
                    strokeLinecap="round"
              ...
              <h2 className="text-sm mb-2">{product.category}</h2>
